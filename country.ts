...
export class Country {
    ...
    // TODO maybe the responsibility of the SVGDrawable class?
    ...
    public isNameMatched(guess: string): boolean {
        return this.title.toLowerCase() === guess.toLowerCase();
    }
